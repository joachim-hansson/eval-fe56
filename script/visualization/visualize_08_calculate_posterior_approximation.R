...
source("config.R")
library(ggplot2)
outdataPathRun <- "/home/joape785/eval-fe56-master/outdata_test_run"
plotPath <- paste0(outdataPathRun, "/plots")


finalPars <- read_object(8, "finalPars", outdata_path = outdataPathRun)
finalParCovmat <- read_object(8, "finalParCovmat", outdata_path = outdataPathRun)
optSysDt_allpars <- read_object(7, "optSysDt_allpars", outdata_path = outdataPathRun)
