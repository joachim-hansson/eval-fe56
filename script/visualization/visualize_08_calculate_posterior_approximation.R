...
varnames <- c('TALYS-v1adjust a', 'TALYS-rcadjust p', 'TALYS-vso1adjust p',
...
ggp <- ggp + geom_errorbarh(aes(y=EXPID, xmin=DATAMIN, xmax=DATAMAX), size=0.4, height=0.4)
ggp <- ggp + geom_point(aes(y=EXPID, x=DATA), col='red')
ggp
